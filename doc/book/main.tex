...
% $HeadURL: https://svn.omdoc.org/repos/omdoc/trunk/doc/book/main.tex $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\svnKeyword $HeadURL: https://svn.omdoc.org/repos/omdoc/trunk/doc/book/main.tex $
\begin{document}
...
\part[Applications and Projects]{{\omdoc} Applications and Projects}\label{part:applications}
\Inprojects{preface}
\Inprojects{toc}
