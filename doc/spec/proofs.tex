...
\item[{\element{derive}}] elements specify normal proof steps that derive a new claim from
  ...
  The value \attribute{conclusion}{type}{derive} is reserved for the concluding step of a
  ...
  The value \attribute{gap}{type}{derive} is used for proof steps that are not justified
...
\item[{\element{hypothesis}}] elements allow to specify {\twintoo{local}{assumption}s}
  ...
  the default value is \attribute{no}{inductive}{hypothesis}.
