...
\begin{omtext}
  ...
  {\attribute{cdrevision}{theory}} jointly specify \inlinedef{the {\twindef{content
        dictionary}{version number}}, which consists of two parts, a major
    {\defin{version}} and a {\defin{revision}}, both of which are non-negative
    integers}. For details between the relation between content dictionary status and
  versions consult the {\openmath} standard~\cite{BusCapCar:2oms04}.
\end{omtext}
