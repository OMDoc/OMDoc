...
\begin{omtext}
  ...
  {\twintoo{new}{symbol}} to be a unique object: the one denoted by $\bA$. \inlinedef{We
    speak of a {\twindef{conservative}{extension}} in this case}. So, if $\cT$ was a
...
\begin{omtext}
  ...
  mechanical) {\twintoo{reasoning}{process}es}. \inlinedef{A {\twindef{type}{declaration}}
  ...
  intuitive notations.  \inlinedef{If a type is declared for an expression that is not a
    symbol, we will speak of a {\twindef{term}{declaration}}}.
\end{omtext}
