...
\begin{omtext}
  This is a variant of the \attribute{implicit}{type}{definition} case above. It defines a
  ...
  \attribute{inductive}{type}{definition} and the optional attributes
...
\end{definition}
This form of definition is often used instead of \attribute{simple}{type}{definition} in
...
\attribute{pattern}{type}{definition}.
\end{omgroup}
\end{module}
\end{oldpart}
\end{omgroup}
...
\begin{definition}[id=sordef.def]
  ...
  \attribute{generated}{type}{adt}, and \attribute{loose}{type}{adt} with the meaning
...
\begin{definition}[id=selector.def]
  ...
  is \twinalt{total}{total}{function} (value \attribute{yes}{total}{selector}) or
  \twinalt{partial}{partial}{function} (value \attribute{no}{total}{selector}).  In
...
\attribute{local}{scope}{symbol}) and the attribute \attribute{role}{symbol}
(with values \attribute{type}{role}{symbol}, \attribute{sort}{role}{symbol},
\attribute{object}{role}{symbol}).
