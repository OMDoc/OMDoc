...
\svnInfo $Id: defschemata.tex 8487 2009-08-11 22:09:44Z clange $
...
\begin{definition}[display=flow,id=well-defined.def]
  We say that a definiendum is {\defin{well-defined}}, iff the corresponding definiens
...
\item equations where the left hand side is the defined symbol and the right hand side is
  ...
  {\myfigref{math-def}}. \inlinedef{We call such definitions
    \twindefalt{simple}{simple}{definition}.}
\item general statements that uniquely determine the meaning of the objects or concepts in
  question, as in the second definition in {\myfigref{math-def}}. \inlinedef{We call such
    definitions {\twindefalt{implicit}{implicit}{definition}}; the
  ...
  possible values.  \inlinedef{We call such a set of axioms a
    {\twindefalt{loose}{loose}{definition}} definition.}
\item given as a set of equations, as in the third case of {\myfigref{math-def}}, even
  ...
  right-hand sides. \inlinedef{We call such a definition
    {\twindefalt{inductive}{definition}{inductive}}.}
\end{itemize}
...
{\attribute{type}{definition}} {\attval{implicit}{type}{definition}}.  The necessary
...
\begin{omgroup}{Inductive Definitions}
  ...
  \inlinedef{in {\eldef{requation}} elements whose left and right hand sides are specified
    by the two children}. The first one is called \inlinedef{the {\defin{pattern}}}, and
  the second one \inlinedef{the {\defin{value}}}. The intended meaning of the defined
...
\begin{definition}[id=pattern.def] 
  {\twindefalt{Pattern definitions}{pattern}{definition}} are a special degenerate cases
...
instance, the {\twintoo{Peano}{axioms}} (see {\myfigref{peano}}) introduce the symbols $0$
(the number {\indextoo{zero}}), $s$ (the {\twintoo{successor}{function}}), and $\NN$ (the
set of {\twintoo{natural}{number}s}) and fix their meaning by five axioms. These state
that the set $\NN$ contains exactly those objects that can be constructed from $0$ and $s$
alone (\inlinedef{these symbols are called {\twindef{constructor}{symbol}s} and the
  representations {\twindef{constructor}{term}s}}). Optionally, an abstract data type can
also declare \inlinedef{{\twindef{selector}{symbol}s}, for (partial) inverses of the
...
e.g. $\iota(a,\emptyset)=\iota(a,\iota(a,\emptyset))$. \inlinedef{This kind of sort is called
...
\begin{definition}[display=flow,id=generated.def]
  An abstract data type is called {\defin{loose}}, if it contains elements besides the
  ones generated by the constructors. We consider free sorts more {\defin{strict}} than
...
{\Mylstref{nat-adt}} introduces such a \inlinedef{{\twindef{recognizer}{predicate}}} as
