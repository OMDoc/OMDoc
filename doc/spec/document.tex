...
\item[{\attval{sequence}{type}{omdoc}}] for a succession of paragraphs. This is the
  ...
  \attribute{sequence}{type}{omdoc} is assumed.
...
\begin{definition}[id=ref.def]
  ...
  \omdoc supports two values: \attribute{include}{type}{ref} (the default) for in-text
  replacement and \attribute{cite}{type}{ref} for a proper reference. The first kind of
...
\begin{oldpart}{reconsider this, we may change the \element{omgroup} element to
    \element{omdoc}}
  Let $R$ be a \element{ref} element of type \attribute{include}{type}{ref}.
