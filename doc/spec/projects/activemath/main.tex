...
\begin{project}{activemath}{http://www.activemath.org/}
  \pauthors{The {\activemath} group: Erica Melis\and Giorgi Goguadse\and Alberto
    Gonzales-Palomo\and Adrian Frischauf\and Martin Homik\and Paul Libbrecht\and Carsten
    Ullrich} 
...
preferences. For this, {\twindef{Tutorial}{Component}} requests
{\defin{learning}{object}s} \footnote{Following the classical definitions, learning
...
assembles them to a course skeleton depending on a {\twindef{Learner}{Model}}.  For
details
see~\cite{Ullrich-TutorialPlanningYRT-AIED-2005,Ullrich-InstructionalOntology-ISWC-2004}.

In several stages a {\twindef{Presentation}{Component}} fills and transforms this skeleton
...
\subsubsection{Interactive Concept Map Tool {\scsys{icmap}}}
