...
\begin{definition}[id=math.def]
  ...
  \item[\defis{symbol}] (element \eldef[ns-elt=m]{csymbol}) for arbitrary symbols. The
    ...
    dictionary name.
  \item[\defis{application}] (element\eldef[ns-elt=m]{apply})    
  \item[\defiis{binding}{structure}] (element \eldef[ns-elt=m]{bind} with
...
\begin{definition}[id=omattr.def]
  ...
  {\Mylstref{complex-type-om}} has a more complex one involving types.
\end{definition}
