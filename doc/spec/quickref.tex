...
\svnInfo $Id: quickref.tex 8425 2009-07-17 11:59:54Z kohlhase $
...
\tabelt{dc:contributor}{\METAmodule{spec}}{}{xml:id, role, style, class}{--}{\llquote{text}}
\tabelt{dc:creator}{\METAmodule{spec}}{}{xml:id, role, style, class}{--}{\llquote{text}}\hline
...
\tabelt{dc:date}{\METAmodule{spec}}{}{action, who}{--}{{\atwintoo{ISO}{8601}{norm}}}
...
\tabelt{dc:description}{\METAmodule{spec}}{}{xml:lang}{--}{{\rm{\element{CMP}}content}}
...
\tabelt{dc:format}{\METAmodule{spec}}{}{}{--}{{\rm fixed:} "application/omdoc+xml"}\hline
...
\tabelt{dc:identifier}{\METAmodule{spec}}{}{scheme}{--}{ANY}
...
\tabelt{dc:language}{\METAmodule{spec}}{}{}{--}{{\atwintoo{ISO}{8601}{norm}}}
\tabelt{li}{\RTmodule{spec}}{}{xml:id, style, class, index, verbalizes}{--}{{Math Vernacular}}\hline
\tabelt{cc:license}{\METAmodule{spec}}{}{jurisdiction}{--}{permissions, prohibitions, requirements}
...
\tabelt{metadata}{\METAmodule{spec}}{}{inherits}{--}{({\rm dc-element})*}
...
\tabelt{cc:permissions}{\METAmodule{spec}}{}{reproduction, distribution, derivative\_works}{--}{EMPTY}
...
\tabelt{cc:prohibitions}{\METAmodule{spec}}{}{commercial\_use}{--}{EMPTY}
...
\tabelt{dc:publisher}{\METAmodule{spec}}{}{xml:id, style, class}{--}{ANY}\hline
...
\tabelt{dc:relation}{\METAmodule{spec}}{}{}{--}{ANY}
\tabelt{requation}{\STmodule{spec}}{}{xml:id, style, class}{--}{(\mobjabbr),(\mobjabbr)}
\tabelt{cc:requirements}{\METAmodule{spec}}{}{notice, copyleft,  attribution}{--}{EMPTY}
\tabelt{dc:rights}{\METAmodule{spec}}{}{}{--}{ANY}\hline
...
\tabelt{dc:source}{\METAmodule{spec}}{}{}{--}{ANY}
\tabelt{style}{\PRESmodule{spec}}{format}{xml:lang, requires}{--}{(element | text | recurse | value-of)*}
\tabelt{dc:subject}{\METAmodule{spec}}{}{xml:lang}{--}{{\rm{\element{CMP}}content}}
...
\tabelt{dc:title}{\METAmodule{spec}}{}{xml:lang}{--}{{\rm{\element{CMP}}content}}
\tabelt{tgroup}{\DOCmodule{spec}}{}{xml:id, type, style, class, modules,
  generated-from, generated-via}{+}{{\rm top-level or theory-constitutive element}*}
\tabelt{type}{\STmodule{spec}}{system}{xml:id, for, style, class}{--}{CMP*, (\mobjabbr)}
\tabelt{dc:type}{\METAmodule{spec}}{}{}{--}{{\rm fixed:} "Dataset" {\rm or} "Text" {\rm or} "Collection"}\hline
...
% LocalWords:  insort metacomment xref xmlns xsi xsl schemaLocation tgroup
...
% LocalWords:  omdoc OMI omtext globals th
