...
\begin{myfig}{15-211}{Three slides from 15-211}
  \fbox{\includegraphics[width=5.2cm]{figures/slide-847}}\quad
  \fbox{\includegraphics[width=5.2cm]{figures/slide-862}}\\[1ex]
  \fbox{\includegraphics[width=5.2cm]{figures/slide-863}}\quad
  \fbox{\includegraphics[width=5.2cm]{figures/slide-864}}
\end{myfig}
