...
\begin{omtext}
  ...
  for {\xml}.  {\xslt} programs (\inlinedef{often called {\defin{style sheet}s}}) consist
  of a set of \inlinedef{{\defin{template}s} (rules for the transformation of certain
    nodes in the {\xml} tree)}. These templates are recursively applied to the input tree
