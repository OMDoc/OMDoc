...
% The source original is at https://github.com/KWARC/OMDoc/doc/projects/mathsearch
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{omgroup}[id=mathwebsearch,creators={isucan,miko}]{A Search Engine for Mathematical Formulae}
\ednote{project page: \url{http://search.mathweb.org/}}
...
in {\sref{mws.query}}). {\mmlsearch} finds a document about Parseval's Theorem, more
