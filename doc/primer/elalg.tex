...
\svnInfo $Id: elalg.tex 8429 2009-07-19 11:09:13Z kohlhase $
...
We start off with the theory for {\emph{\indextoo{semigroup}s}}. It introduces two
...
\end{lstlisting}
The theory of {\emph{\indextoo{monoid}s}} is constructed as an extension of the theory of
